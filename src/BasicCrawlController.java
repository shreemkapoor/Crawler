...
public class BasicCrawlController {
    ...
    private final static String crawlStorageFolder = "C:\\Users\\SK\\Desktop\\crawler\\data\\crawl";
   
    private final static int numberOfCrawlers = 7;
    private final static String crawlSeed = "https://www.usatoday.com";
    private final static int maxPageToFetch = 20000;
    private final static int maxDepthOfCrawling = 16;
    private final static String name = "Ananya Sharma";
    private final static String id = "4221566769";
    private final static String newssite = "usatoday.com";
    ...
    public static void saveFetchCsv(CrawlState sumState) throws Exception {
        String fileName = crawlStorageFolder + "\\fetch_usatoday.csv";
    ...
    public static void saveVisitCsv(CrawlState sumState) throws Exception {
        String fileName = crawlStorageFolder + "/visit_usatoday.csv";
        FileWriter writer = new FileWriter(fileName);
    ...
    public static void saveUrlsCsv(CrawlState sumState) throws Exception {
        String fileName = crawlStorageFolder + "/urls_usatoday.csv";
        FileWriter writer = new FileWriter(fileName);
